...
export function BottomMobile() {
  ...
  return (
    ...
    data-isscrolldown={scrollDirection === "down"}
     className="hidden fixed bottom-0 w-full h-14 bg-white border-t-[1px] border-grayBorder sm:block transition-transform duration-200 data-[isscrolldown=true]:-translate-y-[-100%] ">
